...
// Landing page for users who have never logged in.
// Route suggestion in main.js:
//   if (!localStorage.getItem('userId') && path === '/') -> renderLanding()
export async function renderLanding() {
  const features = [
    { icon: 'book-open', title: 'All Your Study Material', body: 'PDFs, videos, presentations and notes for every subject and chapter — uploaded by your teachers, organised so nothing gets lost.' },
